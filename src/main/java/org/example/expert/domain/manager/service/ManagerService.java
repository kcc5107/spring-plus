...
public class ManagerService {
    ...
    @Transactional
    public ManagerSaveResponse saveManager(CustomUserDetails customUserDetails, long todoId, ManagerSaveRequest managerSaveRequest) {
        // 일정을 만든 유저
    ...
    @Transactional
    public void deleteManager(CustomUserDetails customUserDetails, long todoId, long managerId) {
        User user = User.fromAuthUser(customUserDetails);
